...
Public Class FrmCompany
    ...
    Private Sub GridHeader()
        ...
        Dim fieldNames() As String = New String() {"COMPANY_C", "COMPANY_N", "ADDRESS", "CITY", "STATE", "PHONE"}
        Dim I As Integer
    ...
    Private Sub LoadView()
        SQL = "select COMPANY_C,COMPANY_N,ADDRESS,CITY,STATE,PHONE from M_COMPANY "
        FILLGridView(SQL, GridControl1)
    End Sub
    Private Sub SimpleButton3_Click(sender As Object, e As EventArgs) Handles SimpleButton3.Click
        'del
        SQL = "DELETE FROM M_COMPANY WHERE COMPANY_C='" & TextEdit1.Text & "'"
        ExecuteNonQuery(SQL)
        LoadView()
        MsgBox("DELETE SUCCESSFUL", vbInformation, "COMPANY")
    End Sub
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleButton2.Click
        If Not IsEmptyText({TextEdit1, TextEdit2}) = True Then
            ...
            SQL = "SELECT * FROM M_COMPANY WHERE COMPANY_C='" & TCode & "'"
            If CheckRecord(SQL) = 0 Then
                'INSERT
                SQL = "INSERT INTO M_COMPANY (COMPANY_C,COMPANY_N,ADDRESS,CITY,STATE,PHONE) VALUES ('" & TCode & "','" & TDesc & "','" & TAddress & "','" & TCity & "','" & TState & "','" & TPhone & "')"
                ExecuteNonQuery(SQL)
                LoadView()
            ...
            Else
                ...
                If UCase(SimpleButton2.Text) = "UPDATE" Then
                    SQL = "UPDATE M_COMPANY SET COMPANY_N='" & TDesc & "',ADDRESS='" & TAddress & "',CITY='" & TCity & "',STATE='" & TState & "',PHONE='" & TPhone & "' WHERE COMPANY_C='" & TCode & "'"
                    ExecuteNonQuery(SQL)
                    LoadView()
    ...
    Private Sub GridView1_RowCellClick(sender As Object, e As RowCellClickEventArgs) Handles GridView1.RowCellClick
        ...
        Else
            ...
            TextEdit1.Text = GridView1.GetRowCellValue(e.RowHandle, "COMPANY_C").ToString() 'CODE
            TextEdit2.Text = GridView1.GetRowCellValue(e.RowHandle, "COMPANY_N").ToString() 'NAME
