...
Public Class FrmPenerimaan
    ...
    Private Sub LoadView1()
        SQL = "select TRSMG_C,ITEM_C,QTY,UNIT,LOKASI,BATCH,TAGNO, from trsmg_detail"
    ...
    Private Sub FrmPenerimaan_Load(sender As Object, e As EventArgs) Handles Me.Load
        LockAll()
        LockAllDetail()
        SimpleButton6.Enabled = False
        SimpleButton7.Enabled = False
        ...
        If Item = "PENERIMAAN BARANG" Then
            LabelControl89.Text = "PENERIMAAN BARANG"
    ...
    Private Sub FrmPenerimaan_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        PanelControl2.Height = Me.Height - 230
    End Sub
    ...
    Private Sub GridView2_RowCellClick(sender As Object, e As RowCellClickEventArgs) Handles GridView2.RowCellClick
        ...
        Else
            ...
            TextEdit1.Text = GridView2.GetRowCellValue(e.RowHandle, "TRSMG_C").ToString() 'CODE
            TextEdit2.Text = GridView2.GetRowCellValue(e.RowHandle, "TRSMG_T").ToString() 'NAME
            TextEdit3.Text = GridView2.GetRowCellValue(e.RowHandle, "REFF").ToString() 'REFF
            TextEdit4.Text = GridView2.GetRowCellValue(e.RowHandle, "NO_SJ").ToString() 'SURATJALAN
            TextEdit5.Text = GridView2.GetRowCellValue(e.RowHandle, "NO_FAK").ToString() 'NO FAKTUR
            TextEdit6.Text = GridView2.GetRowCellValue(e.RowHandle, "NO_PO").ToString() 'NO PO
            TextEdit7.Text = GridView2.GetRowCellValue(e.RowHandle, "TRSMG_DATE").ToString() 'TGL MASUK
            TextEdit8.Text = GridView2.GetRowCellValue(e.RowHandle, "TRANSPORTER_C").ToString() 'TRANSPORTER CODE
            TextEdit9.Text = GridView2.GetRowCellValue(e.RowHandle, "VENDOR_C").ToString() 'VENDOR CODE
            TextEdit10.Text = GridView2.GetRowCellValue(e.RowHandle, "CUSTOMER_C").ToString() 'CUSTOMER CODE
            TextEdit11.Text = GridView2.GetRowCellValue(e.RowHandle, "NO_VEHICLE").ToString() 'NO KENDARAAN
            TextEdit12.Text = GridView2.GetRowCellValue(e.RowHandle, "PENERIMA").ToString() 'PENERIMA
            TextEdit13.Text = GridView2.GetRowCellValue(e.RowHandle, "PENGEIRIM").ToString() 'PENGIRIM
            TextEdit14.Text = GridView2.GetRowCellValue(e.RowHandle, "DEP_C").ToString() 'DEP CODE
            TextEdit1.Enabled = False
            UnlockAll()
            LoadView1()
        End If
    ...
    Private Sub GridView1_RowCellClick(sender As Object, e As RowCellClickEventArgs) Handles GridView1.RowCellClick
        ...
        Else
            ...
            SimpleButton2.Text = "Update" 'save
            TextEdit15.Text = GridView2.GetRowCellValue(e.RowHandle, "TRSMG_C").ToString() 'CODE
            TextEdit16.Text = GridView2.GetRowCellValue(e.RowHandle, "ITEM_C").ToString() 'NAME
            TextEdit17.Text = GridView2.GetRowCellValue(e.RowHandle, "QTY").ToString() 'REFF
            TextEdit18.Text = GridView2.GetRowCellValue(e.RowHandle, "LOKASI").ToString() 'SURATJALAN
            TextEdit19.Text = GridView2.GetRowCellValue(e.RowHandle, "BATCH").ToString() 'NO FAKTUR
            TextEdit21.Text = GridView2.GetRowCellValue(e.RowHandle, "TAGNO").ToString() 'TGL MASUK
            TextEdit1.Enabled = False
            UnlockAllDetail()
        End If
    End Sub
