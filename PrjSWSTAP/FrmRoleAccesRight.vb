...
Public Class FrmRoleAccesRight
    ...
    Private Sub LoadRoleMenu(ByVal ROLENAME As String)
        ...
        If ComboBoxEdit1.Text <> "" Then
            Dim ROLEID As String = GetCodeRole(ComboBoxEdit1.Text)
            SQL = "SELECT CONCAT(CONCAT(B.URUT,'.'),COALESCE(B.ACCESSNAME,A.ACCESSNAME)) As GROUP_NAME " +
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        If X > 0 Then
            For i = 0 To X - 1
                ...
                Dim GView1 As GridView = CType(GridControl2.FocusedView, GridView)
                Dim Userid As String = GetCodeUser(CType((GView1.GetRowCellValue(i, "USERNAME")), String))
    ...
    Private Sub UpdateUserRole(ByVal UserId As String, ByVal Roleid As String)
        ...
        Else
            'update
            SQL = "UPDATE T_USERPROFILE SET ROLEID='" & Roleid & "' ,UPDATE_BY='" & USERNAME & "' WHERE USERID='" & UserId & "' AND AKTIF='Y'"
            ExecuteNonQuery(SQL)
        End If
    End Sub
