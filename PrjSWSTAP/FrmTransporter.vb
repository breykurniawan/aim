...
Public Class FrmTransporter
    ...
    Private Sub GridHeader()
        ...
        Dim fieldNames() As String = New String() {"TRANSPORTER_C", "TRANSPORTER_N", "ADDRESS", "CITY", "STATE", "PHONE"}
        Dim I As Integer
    ...
    Private Sub SimpleButton3_Click(sender As Object, e As EventArgs) Handles SimpleButton3.Click
        'del
        SQL = "DELETE FROM M_TRANSPORTER WHERE TRANSPORTER_C='" & TextEdit1.Text & "'"
        ExecuteNonQuery(SQL)
        LoadView()
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleButton2.Click
        If Not IsEmptyText({TextEdit1, TextEdit2}) = True Then
            ...
            SQL = "SELECT * FROM M_TRANSPORTER WHERE TRANSPORTER_C='" & TCode & "'"
            If CheckRecord(SQL) = 0 Then
                'INSERT
                SQL = "INSERT INTO M_TRANSPORTER (TRANSPORTER_C,TRANSPORTER_N,ADDRESS,CITY,STATE,PHONE) VALUES ('" & TCode & "','" & TDesc & "','" & TAddress & "','" & TCity & "','" & TState & "','" & TPhone & "')"
                ExecuteNonQuery(SQL)
                LoadView()
            ...
            Else
                ...
                If UCase(SimpleButton2.Text) = "UPDATE" Then
                    SQL = "UPDATE M_TRANSPORTER SET TRANSPORTER_N='" & TDesc & "',ADDRESS='" & TAddress & "',CITY='" & TCity & "',STATE='" & TState & "',PHONE='" & TPhone & "' WHERE TRANSPORTER_C='" & TCode & "'"
                    ExecuteNonQuery(SQL)
                    LoadView()
    ...
    Private Sub GridView1_RowCellClick(sender As Object, e As RowCellClickEventArgs) Handles GridView1.RowCellClick
        ...
        Else
            ...
            TextEdit1.Text = GridView1.GetRowCellValue(e.RowHandle, "TRANSPORTER_C").ToString() 'CODE
            TextEdit2.Text = GridView1.GetRowCellValue(e.RowHandle, "TRANSPORTER_N").ToString() 'NAME
